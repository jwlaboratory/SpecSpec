...
| 9 | 2026-07-17 | **multilingual EAGLE v2** | as v1, shadowing FIXED (`perm` rename), lr 1e-4, aux `1:std` | running | `multilingual_eagle/results/` |
| 10 | 2026-07-17 | **weird-domains EAGLE v2** | as v1, fixed | running | `weird-domains/results/eagle_*` |
| 11 | 2026-07-17 | **multilingual DFlash r64** | 6× rank-64 (α=128) LoRA — does deeper rank help more? base benches reused from #3 | running | `multilingual/results/*_r64*` |
