"""
Instrumented copy of DFlash's `spec_generate`.

The upstream `spec_generate` (in the model repo's dflash.py) computes per-step
...
def make_instrumented_spec_generate(model):
    ...
    Accepted draft tokens on step i = acceptance_lengths[i] - 1, out of
    (block_size - 1) proposed draft tokens.
    """
